...
<table><tr><td>input id</td><td><input type="text" name="ID" /></td><td><input type="submit" name="SARCH" /></td></tr></table>
<?php
...
$ID=$_SESSION['A'];
 $stmt = $db_con->prepare("SELECT * FROM basic  WHERE ID='$ID'");
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
<div style="position: absolute;  height: 593px; width: 1275px; left: 29px; top: 78px; background-color:#C39;">
